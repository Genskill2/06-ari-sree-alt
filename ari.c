...
count sentences_count=no_of_sentences(paragraph);
int score=score_formula(char_count,word_count,sentence_count);

string GradeLevel[14]={"Kindergarten","First/Second Grade","Third Grade","Fourth Grade",
"Fifth Grade","Sixth Grade","Seventh Grade","Eight Grade","Ninth Grade","Tenth Grade","Eleventh Grade",
"Twelfth Grade","College Student","Professor"};
if(score>14){
...
float ret=4.17*(float)characters/words+0.5*(float)words/sentences-21.43;
